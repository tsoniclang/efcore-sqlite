...
export abstract class SqliteDbContextOptionsBuilderExtensions$instance {
    static UseSqlite<TContext extends unknown & { readonly __tsonic_type_Microsoft_EntityFrameworkCore_DbContext: never }>(optionsBuilder: DbContextOptionsBuilder_1<TContext>, sqliteOptionsAction?: Action_1<SqliteDbContextOptionsBuilder> | null): DbContextOptionsBuilder_1<TContext>;
    static UseSqlite<TContext extends unknown & { readonly __tsonic_type_Microsoft_EntityFrameworkCore_DbContext: never }>(optionsBuilder: DbContextOptionsBuilder_1<TContext>, connection: DbConnection, sqliteOptionsAction?: Action_1<SqliteDbContextOptionsBuilder> | null): DbContextOptionsBuilder_1<TContext>;
    static UseSqlite<TContext extends unknown & { readonly __tsonic_type_Microsoft_EntityFrameworkCore_DbContext: never }>(optionsBuilder: DbContextOptionsBuilder_1<TContext>, connection: DbConnection, contextOwnsConnection: boolean, sqliteOptionsAction?: Action_1<SqliteDbContextOptionsBuilder> | null): DbContextOptionsBuilder_1<TContext>;
    static UseSqlite<TContext extends unknown & { readonly __tsonic_type_Microsoft_EntityFrameworkCore_DbContext: never }>(optionsBuilder: DbContextOptionsBuilder_1<TContext>, connectionString: string | null, sqliteOptionsAction?: Action_1<SqliteDbContextOptionsBuilder> | null): DbContextOptionsBuilder_1<TContext>;
